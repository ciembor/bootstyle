...
<html lang="en">
  <head>
    ...
    <!-- Le styles -->
    <link id="bootstyle" href="../bootstrap/docs/assets/css/bootstrap.css" rel="stylesheet">
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="./index.html">Bootstyle</a>
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li>
                <select id="styles" name="styles" style="margin: 6px 0 0 6px;">
                  <?php
...
<header class="jumbotron subhead" id="overview">
  <h1>Bootstyle preview site</h1>
  <p class="lead">Modification of <a href="http://twitter.github.com/bootstrap/components.html">Twitter Bootstrap "Components" page</a>.</p>
  <div class="subnav">
...
<pre class="prettyprint linenums">&lt;a class="close" href="#"&gt;&amp;times;&lt;/a&gt;</pre>
    ...
    <script>
      $("#styles").change(function(){
        $("#bootstyle").attr("href", "./" + encodeURIComponent($("#styles").val()) + "/bootstyle.css");
        console.log(encodeURIComponent($("#styles").val()) + "/bootstyle.css");
      });
    </script>
